...
Buscando una aplicación base para trabajar con el Myo Armband, encontré una portal en donde se pueden descargar herramientas, librerías, y aplicaciones para Android Studio.
